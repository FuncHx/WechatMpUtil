...
(
    ...
    `authority_comment` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci         NULL COMMENT ' 权限说明 ',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '权限表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of permission
-- ----------------------------
INSERT INTO `permission`
VALUES (1, '/user' , '用户管理权限');
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '角色表' ROW_FORMAT = Dynamic;
...
(
    ...
    `permissin_id` int(0) NULL DEFAULT NULL,
    PRIMARY KEY (`id`) USING BTREE,
    INDEX `role_permission_relation_permission_id_fk` (`permissin_id`) USING BTREE,
    INDEX `role_permission_relation_role_id_fk` (`role_id`) USING BTREE,
    CONSTRAINT `role_permission_relation_permission_id_fk` FOREIGN KEY (`permissin_id`) REFERENCES `permission` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '角色权限关联表' ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户信息表' ROW_FORMAT = Dynamic;
...
VALUES (2, 'root', 'W', '', '', '0', '',
        '{bcrypt}$2a$10$ChfXi.t6JPXEbqwMNizpnuZJJ9RXWUpRq8tLWuWFc3Z.uN.0wpYlG', '1', '0', '', NULL);
...
(
    ...
    CONSTRAINT `user_role_relation_sys_user_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `sys_user` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '微信自动回复' ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '微信消息' ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '微信用户' ROW_FORMAT = Dynamic;
